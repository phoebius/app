 ...
 * Autogenerated class
 */
abstract class AutoContentPageEntity extends LazySingleton implements IQueryable
{
	/**
	...
	{
		return new ContentPageEntityLogicalSchema;
	}
	...
	{
		return new ContentPageEntityPhysicalSchema;
	}
}
